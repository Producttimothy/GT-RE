...
const privacyStorageKey = 'gt_privacy_notice_v2';
let privacyNotice;
...
const showPrivacyNotice = () => {
  ...
  privacyNotice.innerHTML = `<div class="cookie-copy"><span class="cookie-kicker">Datenschutz</span><h2 id="cookie-title">Keine Analyse- oder Marketing-Cookies</h2><p>Diese Website speichert nur Ihre Bestätigung dieses Hinweises lokal im Browser. Formspree wird erst beim Absenden einer Anfrage kontaktiert; Portal24 erst, wenn Sie das Kundenportal öffnen. Es werden keine Google Fonts geladen.</p><a href="datenschutz.html">Details in der Datenschutzerklärung</a></div><button class="button button-light cookie-button" type="button">Verstanden</button>`;
